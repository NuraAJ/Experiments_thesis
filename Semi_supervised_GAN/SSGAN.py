...
class Dataset:
    def __init__(self, train, test, val_frac=0., shuffle=True, scale_func=None):
...
def discriminator(x, reuse=False, alpha=0.2, drop_rate=0., num_classes=20, size_mult=64):
    print("\n###################################################\n")
...
def generator(z, output_dim, reuse=False, alpha=0.2, training=True, size_mult=32):
    print("\n###################################################\n")
